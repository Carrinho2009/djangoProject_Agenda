...
from Agenda.serializers import ContatoSerializers, TelefoneSerializers, EmailSerializers, EmergenciaSerializers
from Agenda.filters import ContatoFilter, TelefoneFilter, EmailFilter, EmergenciaFilter
